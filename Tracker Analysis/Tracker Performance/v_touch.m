...
h = size(handles.Data.Output.Objects, 1);
w = size(handles.Data.Output.Objects, 2);

handles.fig = figure(1);
set(gcf,'position',[100 100 view_heigth view_heigth*(h/w)]);
...
handles.disp_inf.nframes = handles.Data.Settings.Nframes;
